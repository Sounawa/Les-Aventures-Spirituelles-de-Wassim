  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-orange-400 via-violet-500 to-violet-500 shadow-inner" />
        ...
        <div
          className={`absolute inset-0 rounded-xl flex items-center justify-center shadow-md ${
            isMatched
              ? 'bg-violet-50 dark:bg-violet-900/30 border-2 border-violet-300 dark:border-violet-600'
              : 'bg-white dark:bg-stone-800 border border-orange-200 dark:border-stone-600'
          }`}
        ...
        >
          ...
          {isMatched && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="absolute -top-1 -right-1 w-5 h-5 bg-violet-400 dark:bg-violet-500 rounded-full flex items-center justify-center shadow-sm"
            >
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="mx-auto w-20 h-20 rounded-full bg-gradient-to-br from-orange-200 via-yellow-300 to-violet-400 flex items-center justify-center shadow-lg"
        >
        ...
        <div className="flex gap-3 pt-2">
          <Button
            variant="outline"
            onClick={onBack}
            className="flex-1 border-orange-200 dark:border-stone-600 text-stone-600 dark:text-stone-300 hover:bg-orange-50 dark:hover:bg-stone-800"
          >
            Retour
          </Button>
          <Button
            onClick={onReplay}
            className="flex-1 bg-gradient-to-r from-orange-500 to-violet-500 hover:from-orange-600 hover:to-violet-600 text-white shadow-md"
          >
