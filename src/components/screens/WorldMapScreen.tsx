      ...
      <div className="sticky top-0 z-10 bg-orange-50/80 dark:bg-stone-900/80 backdrop-blur-sm border-b border-orange-200/30 dark:border-stone-700/30">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="ml-auto">
            <span className="text-xs font-semibold text-orange-700 dark:text-orange-400 bg-orange-100 dark:bg-orange-900/30 px-2.5 py-1 rounded-full">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-xs font-bold text-orange-700 dark:text-orange-400">{Math.round(overallProgress)}%</span>
          </div>
          ...
          <div className="flex items-center gap-4 text-[10px] text-stone-500 dark:text-stone-400">
            <div className="flex items-center gap-1.5">
              <div className="w-3 h-3 rounded-full bg-violet-500 shadow-sm shadow-violet-200" />
              <span>Terminé</span>
            </div>
            <div className="flex items-center gap-1.5">
        ...
        <div className="relative">
          ...
          <div className="absolute left-6 top-0 bottom-0 w-1.5 bg-gradient-to-b from-orange-300/50 via-stone-300/30 to-transparent dark:from-orange-600/30 dark:via-stone-600/15 rounded-full" />
                        ...
                        >
                          ...
                          <button
                            ...
                            className={`w-full text-left rounded-xl p-3.5 transition-all flex items-center gap-3 ${
                              isChapterUnlocked
                                ? 'glass-card hover:shadow-md cursor-pointer group border border-transparent hover:border-orange-200/40 dark:hover:border-orange-700/30'
                          ...
                          >
                            ...
                            <div
                              className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg shrink-0 transition-all ${
                                isCompleted ? 'bg-violet-100 dark:bg-violet-900/30 shadow-sm' :
                                isChapterUnlocked ? 'bg-orange-100 dark:bg-orange-900/30 shadow-sm' :
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-1.5">
                                ...
                                {isCompleted && (
                                  <span className="text-[9px] text-violet-600 dark:text-violet-400 bg-violet-100 dark:bg-violet-900/20 px-1.5 py-0.5 rounded-full font-medium">
                                    Terminé
                                  </span>
                                )}
                              </div>
                              <p className={`text-xs font-semibold truncate mt-0.5 ${
                                isCompleted ? 'text-violet-700 dark:text-violet-400' :
                                isChapterUnlocked ? 'text-stone-800 dark:text-stone-100 group-hover:text-orange-700 dark:group-hover:text-orange-400' :
                                'text-stone-400'
                              }`}>
                                {chapter.title}
                              </p>
