    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-50 via-violet-50 to-orange-50 dark:from-stone-900 dark:via-stone-900 dark:to-stone-950">
      ...
      <div className="sticky top-0 z-10 bg-orange-50/80 dark:bg-stone-900/80 backdrop-blur-sm border-b border-orange-200/30 dark:border-stone-700/30">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-orange-600 dark:text-orange-400 truncate font-amiri" dir="rtl">{tome.titleAr}</p>
          </div>
          <div className="flex items-center gap-1 text-xs font-medium text-orange-700 dark:text-orange-400 bg-orange-100 dark:bg-orange-900/30 px-2 py-1 rounded-full shrink-0">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="relative">
          {/* Vertical path line */}
          <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-orange-300/50 via-orange-200/30 to-transparent dark:from-orange-500/30 dark:via-orange-400/20" />
                ...
                >
                  ...
                  >
                    {isCompleted ? (
                      ...
                      <span className="text-xs font-bold text-orange-600">{chapter.number}</span>
                    ) : (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className="font-bold text-stone-800 dark:text-stone-100 text-sm group-hover:text-orange-700 dark:group-hover:text-orange-400 transition-colors">
                          {chapter.title}
                        </h3>
                        <p className="text-sm text-orange-600 dark:text-orange-400 font-amiri" dir="rtl">{chapter.titleAr}</p>
