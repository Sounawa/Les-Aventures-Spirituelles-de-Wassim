          ...
          <div className="space-y-4">
            ...
            {allLessons.map((lesson, idx) => (
              ...
              >
                ...
                <blockquote className="border-l-3 border-sky-400 pl-4 italic text-stone-500 dark:text-stone-400 text-sm bg-sky-50/50 dark:bg-sky-900/10 py-2 rounded-r-lg">
                  « {lesson.quote} »
                </blockquote>
