        ...
        >
          ...
          <div className="relative w-24 h-24 mx-auto mb-4">
            <svg width="96" height="96" className="-rotate-90">
              <circle cx="48" cy="48" r="40" fill="none" stroke="currentColor" strokeWidth="6" className="text-stone-100" />
              <motion.circle
                cx="48" cy="48" r="40"
              ...
              <motion.div
                ...
                className={`rounded-xl border p-4 text-center transition-all relative overflow-hidden ${
                  isEarned
                    ...
                    : 'bg-white/30 border-stone-200/40 opacity-40'
                }`}
                  ...
                  {isEarned && (
                    <>
                      ...
                      <div className="mt-2 pt-2 border-t border-stone-200/50">
                        <p className="text-[10px] text-stone-500 leading-relaxed">{badge.description}</p>
                      </div>
