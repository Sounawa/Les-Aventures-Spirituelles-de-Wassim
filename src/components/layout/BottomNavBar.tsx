...
export function BottomNavBar() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="glass-card border-t border-orange-200/30 dark:border-stone-700/30 rounded-none px-2 py-1">
                ...
                >
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute -top-1 w-8 h-1 rounded-full bg-gradient-to-r from-orange-500 to-violet-500"
