...
const backgrounds: Record<string, BackgroundConfig> = {
  ...
  garden: {
    ...
    darkGradient: 'from-emerald-950 via-lime-950 to-amber-950',
    pattern: '🌿',
    decorativeElements: ['🌿', '🌱', '🦋'],
  ...
  zawiyah: {
    ...
    darkGradient: 'from-amber-950 via-orange-950 to-yellow-950',
    pattern: '🕌',
    decorativeElements: ['🕌', '📖', '🤲'],
  ...
  golden_city: {
    ...
    darkGradient: 'from-yellow-950 via-amber-950 to-orange-950',
    pattern: '🏙️',
    decorativeElements: ['🏙️', '✨', '👑'],
  ...
  classroom: {
    ...
    darkGradient: 'from-stone-900 via-amber-950 to-yellow-950',
    pattern: '✏️',
    decorativeElements: ['✏️', '📝', '📐'],
...
export function StoryBackground({ background }: StoryBackgroundProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 w-8 h-8 border-t-2 border-l-2 border-amber-300/30 dark:border-amber-500/20 rounded-tl-lg" />
      <div className="absolute top-3 right-3 w-8 h-8 border-t-2 border-r-2 border-amber-300/30 dark:border-amber-500/20 rounded-tr-lg" />
      <div className="absolute bottom-3 left-3 w-8 h-8 border-b-2 border-l-2 border-amber-300/30 dark:border-amber-500/20 rounded-bl-lg" />
      <div className="absolute bottom-3 right-3 w-8 h-8 border-b-2 border-r-2 border-amber-300/30 dark:border-amber-500/20 rounded-br-lg" />

      {/* Bottom gradient fade */}
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-amber-50/50 via-amber-50/20 to-transparent dark:from-stone-950/50 dark:via-stone-950/20 pointer-events-none" />
    </motion.div>
  );
}
