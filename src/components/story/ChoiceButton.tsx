  ...
  return (
    <motion.button
      ...
      className={
        ...
        'border-orange-300/50 dark:border-stone-600/30 ' +
        'parchment-card dark:bg-stone-800/60 ' +
        'hover:shadow-lg ' +
        'hover:border-orange-400 dark:hover:border-stone-500/50 ' +
        'hover:bg-orange-50/50 dark:hover:bg-stone-800/80'
      }
    >
      {/* Left accent bar */}
      <div
      ...
      <div className="absolute inset-0 opacity-5 group-hover:opacity-10 transition-opacity">
        <div className="absolute top-0 right-0 w-20 h-20 border border-orange-600 rotate-45 translate-x-10 -translate-y-10" />
        <div className="absolute bottom-0 left-0 w-16 h-16 border border-orange-600 rotate-45 -translate-x-8 translate-y-8" />
      </div>

      {/* Shimmer on hover */}
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-r from-transparent via-orange-100/20 dark:via-orange-500/10 to-transparent" />
