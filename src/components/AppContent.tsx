...
function AppInner() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-orange-50 via-violet-50 to-orange-50 dark:from-stone-900 dark:via-stone-900 dark:to-stone-950 transition-colors duration-500">
      <ThemeHandler />
      <OnboardingModal />
      ...
      <footer className="mt-auto relative transition-colors duration-500">
        {/* Top gradient border */}
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-orange-400/40 dark:via-orange-500/30 to-transparent" />
        <div className="glass-card border-t border-orange-200/30 dark:border-stone-700/30 py-4 pb-20 md:pb-4">
          <div className="max-w-2xl mx-auto px-4 text-center">
            <p className="text-[10px] text-stone-500 dark:text-stone-400">
              Les Aventures Spirituelles de Wassim — مغامرات وسيم الروحية
            </p>
            <div className="flex items-center justify-center gap-2 my-1">
              <span className="text-orange-400 dark:text-orange-500 text-xs">🌙</span>
              <span className="text-stone-300 dark:text-stone-600">✦</span>
              <span className="text-orange-300 dark:text-orange-500 text-[10px]">⭐</span>
              <span className="text-stone-300 dark:text-stone-600">✦</span>
              <span className="text-orange-400 dark:text-orange-500 text-xs">🌙</span>
            </div>
