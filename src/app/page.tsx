...
const screenComponents: Record<ScreenType, React.ComponentType> = {
  ...
  lesson: LessonScreen,
  quiz: () => <div className="min-h-screen flex items-center justify-center text-stone-400">Quiz — Bientôt disponible</div>,
  settings: () => <div className="min-h-screen flex items-center justify-center text-stone-400">Paramètres — Bientôt disponible</div>,
};
