...
export const tome2_wassim: Tome = {
  ...
  chapters: [
    ...
    // ============================================================
    // CHAPTER 2 — Le Rêve des Étoiles ✨
    // ============================================================
    {
      id: 'wt2c2',
      tomeId: 'wassim_tome2',
      number: 2,
      title: 'Le Rêve des Étoiles',
      titleAr: 'حلم النجوم',
      scenes: [
        // --- wt2c2s1: Wassim vole ! 🚀 ---
        {
          ...
          title: 'Wassim vole ! 🚀',
          narration:
            'Dans son lit, Wassim dort profondément. 💤\n\nMais dans son rêve... quelque chose de magique arrive ! ✨\n\nWassim se lève et... il vole ! 🚀 Il vole au-dessus de Fès, au-dessus des toits, au-dessus de tout !\n\nLe ciel est rempli d\'étoiles dorées. Elles sont immenses ! Et elles brillent comme des lanternes magiques. 🏮🌟\n\nWassim rit de joie ! C\'est le plus beau rêve de sa vie ! 🤩',
          dialogues: [
            {
              characterId: 'wassim',
              text: 'Waouh ! Je vole ! 🚀✨ Les étoiles sont partout ! C\'est trop beau ! 🤩',
              emotion: 'happy',
            },
          ],
          choices: [],
        ...
        // --- wt2c2s2: Les étoiles parlent ! 💬⭐ ---
        {
          id: 'wt2c2s2',
          chapterId: 'wt2c2',
          title: 'Les étoiles parlent ! 💬⭐',
          narration:
            'Wassim vole vers une grande étoile toute dorée. ⭐\n\nEt là... l\'étoile lui parle ! « Salam Wassim ! 🌟 Je suis une étoile d\'Allah ! »\n\nWassim est étonné ! Une étoile qui parle ?! 😮\n\nUne autre étoile arrive. Elle est toute bleue ! « Wassim, Allah t\'aime ! 💕 Très très fort ! Plus fort que toutes les étoiles ! » 🌟💙\n\nEt une troisième étoile, toute rose, dit : « Wassim, prie avec ton cœur ! 🤲 Allah écoute tes prières ! » 🌟💗',
          dialogues: [
            {
              characterId: 'wassim',
              text: 'Vous parlez ?! 😮 Mais... les étoiles ne parlent pas d\'habitude !',
              emotion: 'surprised',
            },
            {
              characterId: 'wassim',
              text: 'C\'est vrai ? Allah m\'aime ? 💕 Même moi, Wassim ? 🤩',
              emotion: 'happy',
            },
            {
              characterId: 'wassim',
              text: 'Prier avec mon cœur... 🤲 Je vais essayer ! 💪',
              emotion: 'determined',
            },
          ],
          choices: [],
          ...
          background: 'inner_world',
          lesson: {
            title: 'Allah nous aime 💕',
            content:
              'Super Wassim ! 🌟 Les étoiles lui ont dit quelque chose de très vrai : Allah nous aime tous ! Même toi ! Allah aime chaque enfant sur la Terre. Son amour est plus grand que toutes les étoiles réunies ! 💕✨',
            quote: 'وَهُوَ الْغَفُورُ الْوَدُودُ',
            source: 'Coran, Sourate Al-Buruj (85:14)',
          },
        },

        // --- wt2c2s3: La lune apprend à Wassim 🌙 ---
        {
          id: 'wt2c2s3',
          chapterId: 'wt2c2',
          title: 'La lune apprend à Wassim 🌙',
          narration:
            'Une grande lune souriante arrive devant Wassim. 🌙😊\n\nElle est énorme et toute blanche ! « Bonsoir Wassim ! Je suis la lune ! Tu veux que je t\'apprenne quelque chose ? »\n\n« Oui oui oui ! » dit Wassim en sautillant dans le ciel. 🤩\n\nLa lune sourit et lève 5 doigts brillants. « Tu vois mes 5 doigts ? C\'est comme les 5 prières ! 🤲\n\n1️⃣ Fajr — le matin, quand le ciel est tout rose 🌅\n2️⃣ Dhuhr — à midi, quand le soleil est tout en haut ☀️\n3️⃣ Asr — l\'après-midi, quand tu rentres de l\'école 🏫\n4️⃣ Maghrib — le soir, quand le soleil se couche 🌇\n5️⃣ Isha — la nuit, comme maintenant ! 🌙 »',
          dialogues: [
            {
              characterId: 'wassim',
              text: '5 prières ! 🤲 Comme les 5 doigts ! C\'est facile à retenir ! 🤩',
              emotion: 'happy',
            },
            {
              characterId: 'wassim',
              text: 'Et maintenant c\'est Isha ! La prière de la nuit ! 🌙',
              emotion: 'happy',
            },
          ],
          choices: [],
          ...
          lesson: {
            title: 'Les 5 prières 🤲',
            content:
              'Bravo ! 🌟 En Islam, on prie 5 fois par jour :\n\n1️⃣ Fajr 🌅 — la prière du matin\n2️⃣ Dhuhr ☀️ — la prière de midi\n3️⃣ Asr 🏫 — la prière de l\'après-midi\n4️⃣ Maghrib 🌇 — la prière du coucher\n5️⃣ Isha 🌙 — la prière de la nuit\n\nChaque prière, c\'est comme dire à Allah : « Je t\'aime ! » 💕',
            quote: 'إِنَّ الصَّلَاةَ تَنْهَىٰ عَنِ الْفَحْشَاءِ وَالْمُنكَرِ',
            source: 'Coran, Sourate Al-Ankabut (29:45)',
          },
        },

        // --- wt2c2s4: Wassim se réveille ! ☀️ ---
        {
          id: 'wt2c2s4',
          chapterId: 'wt2c2',
          title: 'Wassim se réveille ! ☀️',
          narration:
            'Le soleil entre par la fenêtre. ☀️\n\nWassim ouvre les yeux. Il sourit immédiatement ! 😊 Son rêve était merveilleux !\n\nIl court dans le couloir. Ses petites pattes font « tap tap tap » sur les carreaux. 🏃\n\nIl trouve Souhayl qui prend son petit-déjeuner. Souhayl, son grand frère, a 9 ans. Il est sage et gentil. 🧑',
          dialogues: [
            {
              characterId: 'wassim',
              text: 'Souhayl ! Souhayl ! 🌟 J\'ai fait un rêve MAGIQUE !',
              emotion: 'happy',
            },
            {
              characterId: 'souhayl',
              text: 'Un rêve magique ? Raconte-moi, petit frère ! 😊',
              emotion: 'happy',
            },
            {
              characterId: 'wassim',
              text: 'Les étoiles parlaient ! ⭐ Et la lune m\'a appris les 5 prières ! 🌙 Fajr, Dhuhr, Asr, Maghrib, Isha !',
              emotion: 'happy',
            },
            {
              characterId: 'souhayl',
              text: 'Masha\'Allah ! 🌟 Tu sais les 5 prières maintenant ! Je suis fier de toi, Wassim ! Tu veux qu\'on prie ensemble ? 🤲',
              emotion: 'happy',
            },
            {
              characterId: 'wassim',
              text: 'OUI ! Avec mon cœur ! 🤲💕',
              emotion: 'happy',
            },
          ],
          choices: [],
        ...
        // --- wt2c2s5: La prière avec le cœur 🤲 ---
        {
          id: 'wt2c2s5',
          chapterId: 'wt2c2',
          title: 'La prière avec le cœur 🤲💕',
          narration:
            'Wassim et Souhayl font leur prière ensemble. 🤲\n\nWassim fait sa prière comme un grand. Il fait le takbir, il met ses mains sur la poitrine, il s\'incline, il se prosterne. 🤲\n\nDans sa tête, il pense aux étoiles et à la lune de son rêve. ✨🌙\n\nIl dit : « Merci Allah pour ce beau rêve. Merci pour les étoiles. Merci pour papa, maman et Souhayl. 💕 »\n\nSouhayl sourit. Wassim vient le voir. Il lui fait un gros câlin. 🤗\n\n« Bravo Wassim ! 🌟 Tu es un super petit musulman ! Allah est très content de toi ! » 💕',
          dialogues: [
            {
              characterId: 'souhayl',
              text: 'Wassim, tu sais quoi ? Le Prophète ﷺ a dit : « La prière est la chose que Allah aime le plus. » 💕',
              emotion: 'wise',
            },
            {
              characterId: 'wassim',
              text: 'Alors je vais prier TOUS les jours ! 🤲 Les 5 prières ! Promis ! 🌟',
              emotion: 'happy',
            },
            {
              characterId: 'souhayl',
              text: 'Bravo petit frère ! Je suis très fier de toi ! 🌟 Allah t\'aime Wassim ! 💕',
              emotion: 'happy',
            },
          ],
          choices: [],
          background: 'home',
          isEnding: true,
          earnedBadgeId: 'salah_star',
          lesson: {
            title: 'La prière avec le cœur 🤲💕',
            content:
              'Super Wassim ! 🌟 Tu as appris les 5 prières ! La prière (Salah) est très importante en Islam. C\'est le moment où on parle avec Allah. On peut Lui demander tout ce qu\'on veut ! Il nous entend toujours. 💕\n\nMême si tu es petit, ta prière est très précieuse pour Allah. Le Prophète ﷺ a dit : « Priez comme vous m\'avez vu prier. » 🤲\n\nEt n\'oublie pas : Allah t\'ime ! Plus que toutes les étoiles ! ⭐✨',
            quote: 'إِنَّ أَحَبَّ الْأَعْمَالِ إِلَى اللَّهِ الصَّلَاةُ لِوَقْتِهَا',
