      ...
      scenes: [
        ...
        // --- st1c2s3: L'Adab du savoir ---
        {
          ...
          choices: [
            {
              id: 'st1c2s3_c1',
              text: "Poser une question à Sidi Mu'adh pour mieux comprendre",
      ...
      scenes: [
        ...
        // --- st1c3s6: Le gardien de la lumière ---
        {
          ...
          dialogues: [
            ...
            {
              characterId: 'souhayl',
              text: "Bismillah. C'est le début. Le début d'un très long chemin. Mais je suis prêt, Sidi Mu'adh. Avec l'aide d'Allah, je suis prêt.",
              emotion: 'determined',
            },
          ],
          choices: [],
