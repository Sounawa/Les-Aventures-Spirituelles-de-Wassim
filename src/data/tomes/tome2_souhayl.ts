  ...
  chapters: [
    ...
    // ============================================================
    {
      ...
      scenes: [
        ...
        // --- st2c2s3: Wassim et le secret ---
        {
          id: 'st2c2s3',
          chapterId: 'st2c2',
          title: 'Wassim et le secret',
          narration: `Souhayl remonta de la bibliothèque avec la tête pleine des mots d'Ibn Sina. Le concept d'Amana résonnait en lui comme un gong dans une caverne — le savoir est un dépôt sacré, le savoir est une confiance, le savoir est une responsabilité. Mais ce sont les événements de l'après-midi, à la maison, qui allaient transformer cette leçon abstraite en une épreuve concrète.\n\nEn rentrant chez lui, Souhayl trouva Wassim assis sur le seuil de la porte, les genoux serrés contre sa poitrine, le visage enfoui dans ses bras. Le petit garçon de six ans pleurait — pas les sanglots bruyants des enfants qui veulent attirer l'attention, mais des larmes silencieuses, contenues, qui coulaient le long de ses joues potelées comme des ruisseaux tranquilles.\n\nSouhayl s'agenouilla devant lui et posa doucement sa main sur son épaule.\n\n— Wassim, qu'est-ce qui se passe ? Pourquoi tu pleures ?\n\nWassim leva des yeux rougis et gonflés, et dans son regard, Souhayl lut une détresse qu'il n'avait jamais vue chez son petit frère — une détresse mêlée de peur et de honte.\n\n— Souhayl, chuchota-t-il, j'ai fait quelque chose de mal. J'ai cassé le vase en cristal de maman. Le cadeau de mariage de Tante Khadija. Il est tombé et il s'est cassé en morceaux. J'ai ramassé les morceaux et je les ai cachés sous mon lit. Maman ne le sait pas encore.\n\nLe vase en cristal. Souhayl le connaissait — c'était un objet magnifique, un cadeau précieux que Aziza chérissait plus que n'importe quelle autre possession matérielle. Wassim l'avait cassé, et il avait peur. Peur de la colère de sa mère, peur de la punition, peur d'être grondée.\n\nEt là, Souhayl se trouva face à un dilemme. Wassim lui avait confié son secret — un secret qui le faisait souffrir. Le secret était aussi une Amana — un dépôt confié par son frère. Si Souhayl le révélait à sa mère, il trahirait la confiance de Wassim. S'il gardait le silence, il participait indirectement au mensonge de son frère.\n\nLes mots d'Ibn Sina résonnèrent dans son esprit : « Le savoir est une Amana — un dépôt sacré. » Et Souhayl comprit que la confiance ne se limitait pas au savoir — elle s'appliquait à chaque secret, chaque promesse, chaque relation humaine.`,
          dialogues: [
            {
              characterId: 'wassim',
          ...
          choices: [
            {
              id: 'st2c2s3_c1',
              text: "Aider Wassim à dire la vérité à maman — avec douceur et soutien",
            ...
            {
              id: 'st2c2s3_c2',
              text: "Garder le secret pour protéger Wassim",
        ...
        // --- st2c2s4a: La miséricorde du grand frère ---
        {
          ...
          narration: `Souhayl prit la main de son petit frère dans la sienne et la serra doucement. Les mains de Wassim étaient froides et tremblantes, comme les pattes d'un oiseau blessé. Souhayl sentit son cœur se serrer — non pas de colère, mais de compassion. Il se souvint des mots de Sidi Mu'adh : « La vraie sagesse, c'est de savoir comment appliquer la vérité avec douceur. La vérité sans douceur est une épée nue. La vérité avec douceur est une médecine. »\n\n— Wassim, dit-il doucement, je ne vais pas le dire à maman à ta place. Mais je vais t'aider à le dire toi-même. Tu veux bien ?\n\nWassim le regarda avec des yeux écarquillés, partagé entre le soulagement et la terreur.\n\n— Me... moi-même ? Mais maman va être en colère ! Elle va me gronder !\n\n— Peut-être, dit Souhayl. Mais tu sais quoi ? Maman est la personne la plus gentille du monde quand on lui dit la vérité. Elle sera peut-être triste, mais elle sera surtout fière de toi d'avoir eu le courage d'avouer. Écoute, je vais être à côté de toi. On y va ensemble. Et après, peu importe ce qui arrive, je serai là.\n\nWassim hésita. Puis il essuya ses larmes du dos de sa main, renifla bruyamment, et hocha la tête. Souhayl l'aida à se lever, ramassa les morceaux de cristal cachés sous le lit du petit garçon, et ensemble, ils descendirent à la cuisine où Aziza préparait le dîner.\n\n— Maman, commença Wassim d'une voix si petite qu'on l'entendait à peine, j'ai quelque chose à te dire. J'ai cassé le vase de Tante Khadija. Je suis désolé. Je suis vraiment désolé.\n\nAziza posa sa cuillère en bois et se tourna vers son fils. Un instant de silence — un instant qui sembla durer une éternité à Wassim et à Souhayl. Puis Aziza s'agenouilla, ouvrit les bras, et serra Wassim contre elle dans une étreinte chaude et tendre.\n\n— Mon petit trésor, murmura-t-elle dans les cheveux de son fils, le vase n'est qu'un objet. Ce que j'aime le plus au monde, c'est toi. Et le fait que tu aies eu le courage de me dire la vérité me rend plus fière que n'importe quel vase en cristal. Alhamdulillah. Mon Wassim est un garçon sincère.\n\nSouhayl, debout dans l'encadrement de la porte, sentit des larmes monter à ses propres yeux. Il pressa le pendentif contre sa poitrine et sentit la lampe briller — non pas d'une lumière éclatante, mais d'une lumière douce, chaude, comme un foyer en hiver. La lumière de la compassion. La lumière de la Rahma.`,
          dialogues: [
            {
              characterId: 'aziza',
              text: "Le Prophète ﷺ a dit : « Celui qui n'est pas miséricordieux envers les jeunes ne mérite pas de miséricorde. » Wassim, ma petite, tu as eu peur, mais tu as choisi la vérité. Et Souhayl, mon grand, tu as aidé ton frère avec sagesse et douceur. Allah est satisfait de vous deux aujourd'hui.",
              emotion: 'wise',
            },
            {
              characterId: 'wassim',
            ...
            {
              characterId: 'aziza',
              text: "Comment pourrais-je être en colère contre un cœur aussi sincère ? Le vase est cassé, c'est vrai. Mais un cœur sincère vaut mille vases. Allons, mes chéris, aidons-moi à préparer le dîner. Et Souhayl... merci d'être le frère dont Wassim a besoin.",
              emotion: 'happy',
            },
          ],
          choices: [],
        ...
        // --- st2c2s4b: Le silence complice ---
        {
          ...
          narration: `Souhayl promit à Wassim de garder le secret. Le soir même, à table, Aziza remarqua l'absence du vase en cristal de la cheminée du salon. Ses yeux allèrent du mur vide aux visages de ses enfants, posant une question silencieuse que personne n'osa répondre.\n\n— Quelqu'un a vu mon vase ? demanda-t-elle avec une douceur qui, Souhayl le savait, masquait une inquiétude réelle.\n\nSouhayl baissa les yeux. Wassim, à côté de lui, enfouit son visage dans son assiette de couscous. Le silence à table était lourd, oppressant, comme un couvercle posé sur une marmite bouillante.\n\n— Il est tombé, dit Souhayl d'une voix qu'il voulut neutre. Je ne sais pas comment. Je l'ai trouvé en morceaux ce matin.\n\nC'était un mensonge. Pas un mensonge total — le vase était bien tombé et il était bien en morceaux — mais un mensonge par omission, un mensonge qui protégeait Wassim au prix de l'honnêteté de Souhayl. Et ce mensonge, Souhayl le sentit immédiatement, avait un goût amer, comme du lait tourné.\n\nAziza regarda son fils longuement, et Souhayl sut, avec la certitude douloureuse que seuls les enfants peuvent ressentir face à leur mère, qu'elle voyait au-delà de ses mots. Elle ne dit rien ce soir-là, mais dans ses yeux, Souhayl lut une déception silencieuse qui le poursuivit jusqu'au moment où il ferma les yeux.\n\nPendant la nuit, les mots d'Ibn Sina résonnèrent dans ses rêves : « Le savoir est une Amana — un dépôt sacré. Si tu l'utilises pour le bien, tu en es le gardien. Si tu l'utilises pour le mal, tu en es le voleur. » Et Souhayl comprit que la confiance ne se limitait pas au savoir — qu'elle s'appliquait aussi aux secrets qu'on garde, aux mensonges qu'on dit pour « protéger » les autres, aux silences qui participent à la tromperie. Protéger quelqu'un en mentant n'est pas le protéger — c'est le maintenir dans la peur.\n\nLe lendemain matin, Souhayl prit Wassim par la main et, ensemble, ils allèrent trouver leur mère.`,
          dialogues: [
            {
              characterId: 'souhayl',
              text: "Wassim, je dois te dire quelque chose. Hier soir, j'ai menti à maman pour te protéger. Mais j'ai compris que ce n'était pas la bonne chose à faire. Ibn Sina m'a enseigné que la confiance est sacrée, et en mentant pour toi, j'ai trahi la confiance de maman. Nous devons lui dire la vérité. Ensemble.",
              emotion: 'determined',
            },
          ],
          choices: [],
        ...
        // --- st2c2s4c: La vérité brutale ---
        {
          ...
          narration: `Souhayl monta directement au salon où Aziza était en train de ranger les coussins.\n\n— Maman, dit-il sans préambule, c'est Wassim qui a cassé ton vase. Les morceaux sont sous son lit.\n\nWassim, qui le suivait dans l'escalier, se figea sur la dernière marche. Son visage passa de la surprise à la peur, puis à la détresse la plus absolue. Ses yeux se remplirent de larmes, et il s'effondra sur la marche en sanglotant.\n\nAziza se tourna vers Wassim, puis vers Souhayl, et son visage exprima une complexité d'émotions que les mots ne pouvaient pas décrire — surprise, chagrin, mais aussi, et c'est ce qui frappa le plus Souhayl, une déception qui n'était pas dirigée vers Wassim.\n\n— Souhayl, dit Aziza doucement mais fermement, tu aurais dû aider ton frère à me le dire lui-même, pas le dénoncer ainsi. La vérité est une obligation, mais la manière de la dire est aussi importante que la vérité elle-même. Le Prophète ﷺ a dit : « Dites la bonne chose ou taisez-vous. » Dire la vérité sans douceur n'est pas le Sidq — c'est la dureté. Et la dureté, mon fils, n'est pas une vertu.\n\nAziza s'agenouilla devant Wassim et le prit dans ses bras. Puis, regardant Souhayl par-dessus l'épaule de son petit frère, elle ajouta :\n\n— Souhayl, tu as dit la vérité et c'est bien. Mais la prochaine fois, souviens-toi que la vérité est une médecine — elle guérit, mais elle doit être administrée avec soin. Une médecine trop forte peut tuer le patient.\n\nSouhayl sentit le pendentif contre sa poitrine. La lampe ne brillait pas — elle était éteinte, froide, et dans son obscurité, Souhayl lut un avertissement : la vérité sans compassion est stérile.`,
          dialogues: [
            {
              characterId: 'aziza',
    ...
    // ============================================================
    {
      ...
      scenes: [
        ...
        // --- st2c3s5: La transmission ---
        {
          ...
          narration: `Le monde de Fatima Al-Fihri commença à s'effacer doucement, comme un tableau impressionniste que la pluie lave. La mosquée en construction, le chantier animé, les ouvriers figés dans leur geste — tout reprit sa couleur, puis sa forme, puis sa substance, jusqu'à ce que Souhayl se retrouve de nouveau dans la bibliothèque souterraine de la Qarawiyyin, assis face à Sidi Mu'adh, le Manuscrit des Gardiens ouvert sur ses genoux.\n\nMais quelque chose avait changé. Souhayl sentait que ses yeux voyaient différemment, que ses oreilles entendaient différemment, que son cœur ressentait différemment. Les leçons d'Al-Ghazali sur la sincérité, d'Ibn Sina sur la confiance, de Fatima Al-Fihri sur la responsabilité — toutes ces leçons n'étaient plus des concepts abstraits. Elles avaient pris racine en lui, comme des graines dans une terre fertile, et elles poussaient, lentement mais sûrement, transformant non seulement ce qu'il savait, mais ce qu'il était.\n\nSidi Mu'adh le regardait avec des yeux qui brillaient d'une fierté immense. Le vieux sage prit le Manuscrit des Gardiens, le referma délicatement, et le remit sur l'étagère d'où il l'avait tiré. Puis il se tourna vers Souhayl et, avec une solennité que le garçon n'avait jamais vue chez lui, il parla :\n\n— Souhayl Benali, tu as accompli les trois épreuves des Gardiens du Savoir. La première épreuve, celle d'Al-Ghazali, t'a enseigné le Sidq — la véracité, la sincérité sans laquelle le savoir est un mensonge. La deuxième épreuve, celle d'Ibn Sina, t'a enseigné l'Amana — la confiance, la responsabilité sans laquelle le savoir est un danger. La troisième épreuve, celle de Fatima Al-Fihri, t'a enseigné la Hikma — la sagesse, la capacité de partager le savoir selon les besoins de chacun.\n\nSidi Mu'adh se leva, et Souhayl vit que le vieillard tremblait légèrement — non pas de faiblesse, mais d'émotion.\n\n— Souhayl, je suis vieux. Très vieux. J'ai été le gardien de cette bibliothèque pendant plus de quarante ans. Avant moi, il y eut d'autres gardiens, et avant eux, d'autres encore, jusqu'au jour où Fatima Al-Fihri elle-même, par un acte de volonté et de générosité sans précédent, a fondé cette institution et lui a donné une âme. Aujourd'hui, Souhayl, c'est toi qui portes la lumière. Ce n'est pas un fardeau que je t'impose — c'est un honneur que tu as mérité.\n\nSouhayl sentit ses yeux se mouiller. Il pressa le pendentif contre sa poitrine — le pendentif en forme de lampe qui brillait désormais d'une lumière constante, chaude et inébranlable — et leva les yeux vers Sidi Mu'adh.\n\n— Je serai un bon gardien, dit-il d'une voix émue mais déterminée. Je partagerai le savoir avec sincérité, je le protégerai avec confiance, et je le transmettrai avec sagesse. C'est ma promesse. À Allah, à vous, Sidi Mu'adh, et à tous les gardiens qui sont venus avant moi.`,
          dialogues: [
            {
              characterId: 'sidimuadh',
            ...
            {
              characterId: 'souhayl',
              text: "Sidi Mu'adh... est-ce que je pourrai revenir ? Souvent ? Il y a encore tellement à apprendre...",
              emotion: 'neutral',
            },
            {
              characterId: 'sidimuadh',
        ...
        // --- st2c3s6: Le nouveau gardien ---
        {
          ...
          dialogues: [
            ...
            {
              characterId: 'souhayl',
              text: "Je ne l'éteindrai jamais, maman. Je promets de la protéger, de la nourrir et de la partager. C'est ma mission de gardien. Et le premier à qui je veux la partager... c'est Wassim. Il mérite de connaître ce monde aussi. À sa manière, à son rythme, comme m'a appris Fatima Al-Fihri.",
              emotion: 'determined',
            },
            {
              characterId: 'wassim',
            ...
            {
              characterId: 'souhayl',
              text: "Pas un secret, Wassim. Une promesse. Un jour, je vais t'emmener dans le plus beau lieu du monde. Un lieu plein de livres, de lumière et de sagesse. Et là, tu découvriras que le savoir est la plus grande aventure de toutes. Attends-moi, petit frère. Le meilleur est à venir.",
              emotion: 'happy',
            },
            {
              characterId: 'nawfel',
              text: "Et moi aussi, hein ? Tu m'emmèneras ? Je veux voir ce lieu secret dont tu parles depuis des semaines !",
              emotion: 'happy',
            },
          ],
          choices: [],
