...
export const quizQuestions: Record<string, QuizQuestion[]> = {
  ...
  t2c2: [
    ...
    { question: "Que dit Wassim à Souhayl quand celui-ci avoue son erreur ?", options: ["« Tu aurais dû te taire »", "« Je suis fier de toi, c'est courageux de dire la vérité »", "« Ce n'est pas grave »", "« Je le savais déjà »"], correctIndex: 1, explanation: "Wassim, le petit frère de Souhayl, le soutient en reconnaissant le courage qu'il a fallu pour dire la vérité. La famille de Souhayl est un pilier de soutien dans son cheminement spirituel." },
  ...
  t3c2: [
    ...
    { question: "Comment Souhayl applique-t-il la justice dans sa vie quotidienne ?", options: ["Il devient juge à la madrasa", "Il partage équitablement ses affaires avec Wassim", "Il rend des verdicts", "Il écrit un livre de lois"], correctIndex: 1, explanation: "Souhayl apprend à partager avec justice avec son petit frère Wassim. La justice commence à la maison — c'est la leçon d'Umar ibn Al-Khattab appliquée dans la vie de tous les jours." },
