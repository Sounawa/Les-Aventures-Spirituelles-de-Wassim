...
export const duaCategoryConfig: Record<DailyDua['category'], { icon: string; label: string; color: string; borderColor: string; darkBorderColor: string; bgColor: string; darkBgColor: string }> = {
  morning: {
    ...
    darkBorderColor: 'dark:border-sky-700/30',
    bgColor: 'from-sky-50 to-indigo-50',
    darkBgColor: 'dark:from-sky-950/20 dark:to-indigo-950/20',
  },
  evening: {
    icon: '🌙',
    label: 'Soir',
  ...
  before_eating: {
    ...
    darkBorderColor: 'dark:border-indigo-700/30',
    bgColor: 'from-indigo-50 to-sky-50',
    darkBgColor: 'dark:from-indigo-950/20 dark:to-sky-950/20',
  },
  after_eating: {
    icon: '🤲',
    ...
    borderColor: 'border-indigo-300/40',
    darkBorderColor: 'dark:border-indigo-700/30',
    bgColor: 'from-indigo-50 to-green-50',
    darkBgColor: 'dark:from-indigo-950/20 dark:to-green-950/20',
  },
  general: {
    icon: '📿',
    label: 'Général',
  ...
  protection: {
    ...
    darkBgColor: 'dark:from-sky-950/20 dark:to-cyan-950/20',
  },
  gratitude: {
    icon: '💝',
    label: 'Gratitude',
