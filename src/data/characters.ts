...
export const characters: Character[] = [
  {
    ...
    description: "Curieux, mature et réfléchi. Il porte en lui une soif de savoir et de compréhension qui le pousse à chercher la vérité dans chaque situation. Contrairement à son petit frère Nawfel, Souhayl approche le monde avec la patience et la rigueur d'un futur savant. Il est le gardien de la bibliothèque secrète sous la Qarawiyyin.",
  ...
  },
  {
    ...
    nameAr: 'نوفل',
    role: 'Petit frère',
    description: "Petit frère de Souhayl, courageux mais parfois impulsif. Il admire son grand frère et veut le suivre partout. Nawfel possède un cœur pur et une capacité à voir au-delà des apparences que même Souhayl lui envie parfois.",
    age: '8 ans (bientôt 9)',
